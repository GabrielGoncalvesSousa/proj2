...
--Utilizador--
     ...
     INSERT INTO entidade VALUES(1, 'Ruas é conosco', 'Tudo a haver com ruas');
    ...
    VALUES (1,1,'Tampa de esgoto está fora do sitio',TO_DATE('04-12-2018','DD-MM-YYYY'),4900,'Rua das Cabritas',666,1,1,1);
